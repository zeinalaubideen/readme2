 ...
 */
public class Huroof extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View huroof = inflater.inflate(R.layout.huroof, container, false);
        ...
        alif.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(view.getContext(), HuroofDescript.class);
                i.putExtra("harf", 1);
