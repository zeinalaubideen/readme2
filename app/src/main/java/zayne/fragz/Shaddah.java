...
import zayne.foundationsfinal.ShaddahDescrip;

/**
 * A simple {@link Fragment} subclass.
 */
public class Shaddah extends Fragment {

    ImageButton  ba, ta, tha, jeem, ha,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View huroof = inflater.inflate(R.layout.fragment_shaddah, container, false);
        ...
        ba.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(view.getContext(), ShaddahDescrip.class);
                i.putExtra("harf", 2);
