...
public class ShortVowels extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View huroof = inflater.inflate(R.layout.fragment_short_vowels,container, false);
        ...
        alif.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(view.getContext(), ShortVDescript.class);
                i.putExtra("harf", 1);
