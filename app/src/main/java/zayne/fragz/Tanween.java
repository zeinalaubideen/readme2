...
import zayne.foundationsfinal.ShortVDescript;
import zayne.foundationsfinal.SukoonDescrip;
import zayne.foundationsfinal.TanweenDescription;

/**
 * A simple {@link Fragment} subclass.
 */
public class Tanween extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View huroof =  inflater.inflate(R.layout.fragment_tanween, container, false);
        ...
        alif.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(view.getContext(), TanweenDescription.class);
                i.putExtra("harf", 1);
